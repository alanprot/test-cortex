...
func (t *Cortex) initQueryable() (serv services.Service, err error) {
	...
	t.QuerierQueryable, t.QuerierEngine = t.QuerierFactory(t.Cfg.Querier, t.Overrides, t.Distributor, t.StoreQueryables, t.TombstonesLoader, querierRegisterer, util_log.Logger)
...
func (t *Cortex) initRuler() (serv services.Service, err error) {
	...
	queryable, engine := t.QuerierFactory(t.Cfg.Querier, t.Overrides, t.Distributor, t.StoreQueryables, t.TombstonesLoader, rulerRegisterer, util_log.Logger)
